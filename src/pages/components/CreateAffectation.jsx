...
function CreateAffectationBtn() {
  const dispatch = useDispatch();

  const products = useSelector((state) => state.products.products);
  const capacity = useSelector((state) => state.capacity.capacity.data);
  const operator = useSelector((state) => state.operation.operator.data);
        ...
        <DialogContent>
          ...
          <div className="mt-4">
            <TextField
              ...
              fullWidth
            >
              <MenuItem value={1}>Volume1</MenuItem>

              <MenuItem value={2}>Volume2</MenuItem>
            </TextField>
          </div>
...
export default CreateAffectationBtn;
